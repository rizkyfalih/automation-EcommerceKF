...
WebUI.setText(findTestObject('Page_Login  Kimia Farma/input_Login_email'), 'rizky.falih@gits.id')

WebUI.setText(findTestObject('Page_Login  Kimia Farma/input_Login_password'), '12345678')
